...
class WatsonXAI:
    ...
    def __init__(self):
        ...
        self.docsearch = Chroma.from_documents(all_chunks, embeddings)
        ...
        self.model = WatsonxLLM(
            model_id=ModelTypes.LLAMA_3_1_70B_INSTRUCT.value,
    ...
    def query(self, new_query):
        ...
        retrieved_docs = self.docsearch.similarity_search(new_query, 3)
        ...
        generated_response = self.model.invoke(combined_prompt)
